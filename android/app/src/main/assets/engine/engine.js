...
export class Stockfish {
    ...
    initWorker() {
        ...
        console.log("Using engine at:", enginePath);
    
        try {
            this.worker = new Worker(enginePath);  // Use the resolved path for worker initialization
            ...
            // Additional setup for the worker
